   ...
   */
    Array.from({ length: numPages }).forEach((_, i) => {
        actions.createPage({
            ...
            otherwise if index is larger then 0, add 1 to the index */
            ...
            context: {
                ...
                In the next iteration of the loop, the page 2, the index value is 1,
     ...
     // Create single blog posts For each edge in the query, create a new page
      data.allMdx.edges.forEach(edge => {
      /* take in the values from the query for slug and id and store them in slug and id const to be used in the createPage method 
